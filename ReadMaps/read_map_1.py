...
class GridWorld():
    ...
    def print_grid_world(self):
        ...
        ax.grid(which='minor', alpha=0.2)
        ax.grid(which='major', alpha=0.5)
        plt.savefig('astar_grid_world/map_1')
        plt.show()
...
if __name__ == '__main__':
    ...
    grad_word.make_grid_world()
    grad_word.print_grid_world()
    #
    # for i in range(len(grad_word.matrix)):
    #     for j in range(len(grad_word.matrix[0])):
    #         print(grad_word.matrix[i, j])
